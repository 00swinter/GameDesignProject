...
public class camera : MonoBehaviour
{
	...
	[SerializeField] public GameObject seedText;
	...
	void Awake()
	{
		...
		foreach (overlayManager om in allOverlayManager)
		{
			...
			seedText.GetComponent<TextMeshProUGUI>().text = "Seed: " + gameSeed.ToString();
		}
	...
	void updatePoints()
	{
		...
		pointsTextUiHouse.GetComponent<TextMeshProUGUI>().text = Mathf.CeilToInt(gesamtPoints).ToString() + " Points";
		pointsTextUiShop.GetComponent<TextMeshProUGUI>().text = Mathf.CeilToInt(gesamtPoints).ToString() + " Points";
	}
	...
	public void deselectCityBlock()
	{
		...
		pointsTextUi.GetComponent<TextMeshProUGUI>().text = Mathf.CeilToInt(gesamtPoints).ToString() + " Points Total";
		pointsTextUiHouse.GetComponent<TextMeshProUGUI>().text = Mathf.CeilToInt(gesamtPoints).ToString() + " Points";
		pointsTextUiShop.GetComponent<TextMeshProUGUI>().text = Mathf.CeilToInt(gesamtPoints).ToString() + " Points";
